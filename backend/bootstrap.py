...
To UPGRADE a list of existing users to premium (comma-separated):
  PREMIUM_USERS=alice@example.com,bob@example.com
"""
...
def ensure_premium_users() -> None:
    """Upgrade any emails listed in PREMIUM_USERS env var to premium tier."""
